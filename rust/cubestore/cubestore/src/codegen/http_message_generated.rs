...
pub const ENUM_MAX_HTTP_PARAMETER_VALUE: u8 = 7;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_HTTP_PARAMETER_VALUE: [HttpParameterValue; 8] = [
    HttpParameterValue::NONE,
    HttpParameterValue::UInt64Value,
    HttpParameterValue::Int64Value,
    HttpParameterValue::BoolValue,
    HttpParameterValue::StringValue,
    HttpParameterValue::BinaryValue,
    HttpParameterValue::Float32Value,
...
impl HttpParameterValue {
    pub const NONE: Self = Self(0);
    pub const UInt64Value: Self = Self(1);
    pub const Int64Value: Self = Self(2);
    pub const BoolValue: Self = Self(3);
    pub const StringValue: Self = Self(4);
    pub const BinaryValue: Self = Self(5);
    pub const Float32Value: Self = Self(6);
    pub const Float64Value: Self = Self(7);
    ...
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::NONE => Some("NONE"),
            Self::UInt64Value => Some("UInt64Value"),
            ...
            Self::Float32Value => Some("Float32Value"),
...
impl<'a> UInt64Value<'a> {
    ...
    pub fn v(&self) -> u64 {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<u64>(UInt64Value::VT_V, Some(0)).unwrap() }
    }
}
...
pub struct UInt64ValueBuilder<'a: 'b, 'b> {
    fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> UInt64ValueBuilder<'a, 'b> {
    #[inline]
    pub fn add_v(&mut self, v: u64) {
        self.fbb_.push_slot::<u64>(UInt64Value::VT_V, v, 0);
    }
    #[inline]
    pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> UInt64ValueBuilder<'a, 'b> {
        let start = _fbb.start_table();
        UInt64ValueBuilder {
            fbb_: _fbb,
            start_: start,
...
pub enum Float32ValueOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct Float32Value<'a> {
    pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for Float32Value<'a> {
    type Inner = Float32Value<'a>;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: flatbuffers::Table::new(buf, loc),
...
impl<'a> Float32Value<'a> {
    pub const VT_V: flatbuffers::VOffsetT = 4;

    #[inline]
    pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
        Float32Value { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args Float32ValueArgs,
    ) -> flatbuffers::WIPOffset<Float32Value<'bldr>> {
        let mut builder = Float32ValueBuilder::new(_fbb);
        builder.add_v(args.v);
        builder.finish()
    }
    ...
    pub fn v(&self) -> f32 {
        ...
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe { self._tab.get::<f32>(Float32Value::VT_V, Some(0.0)).unwrap() }
    }
}

impl flatbuffers::Verifiable for Float32Value<'_> {
    #[inline]
    fn run_verifier(
        v: &mut flatbuffers::Verifier,
        pos: usize,
...
pub struct Float32ValueArgs {
    pub v: f32,
}
impl<'a> Default for Float32ValueArgs {
    #[inline]
    fn default() -> Self {
        Float32ValueArgs { v: 0.0 }
    }
}

pub struct Float32ValueBuilder<'a: 'b, 'b> {
    fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> Float32ValueBuilder<'a, 'b> {
    #[inline]
    pub fn add_v(&mut self, v: f32) {
        self.fbb_.push_slot::<f32>(Float32Value::VT_V, v, 0.0);
    }
    #[inline]
    pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> Float32ValueBuilder<'a, 'b> {
        let start = _fbb.start_table();
        Float32ValueBuilder {
            fbb_: _fbb,
            start_: start,
    ...
    #[inline]
    pub fn finish(self) -> flatbuffers::WIPOffset<Float32Value<'a>> {
        let o = self.fbb_.end_table(self.start_);
        flatbuffers::WIPOffset::new(o.value())
    }
}

impl core::fmt::Debug for Float32Value<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let mut ds = f.debug_struct("Float32Value");
        ds.field("v", &self.v());
        ds.finish()
    }
}
...
impl<'a> HttpParameter<'a> {
    ...
    #[inline]
    #[allow(non_snake_case)]
    pub fn value_as_uint_64_value(&self) -> Option<UInt64Value<'a>> {
        if self.value_type() == HttpParameterValue::UInt64Value {
            self.value().map(|t| {
                // Safety:
                // Created from a valid Table for this object
                // Which contains a valid union in this slot
    ...
    #[inline]
    #[allow(non_snake_case)]
    pub fn value_as_float_32_value(&self) -> Option<Float32Value<'a>> {
        if self.value_type() == HttpParameterValue::Float32Value {
            self.value().map(|t| {
                // Safety:
                // Created from a valid Table for this object
                // Which contains a valid union in this slot
                unsafe { Float32Value::init_from_table(t) }
            })
        } else {
            None
        }
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_union::<HttpParameterValue, _>(
                ...
                false,
                |key, v, pos| match key {
                    HttpParameterValue::UInt64Value => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<UInt64Value>>(
                            "HttpParameterValue::UInt64Value",
                            pos,
                        ),
                    ...
                    HttpParameterValue::Float32Value => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<Float32Value>>(
                            "HttpParameterValue::Float32Value",
                            pos,
                        ),
...
impl core::fmt::Debug for HttpParameter<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        match self.value_type() {
            HttpParameterValue::UInt64Value => {
                if let Some(x) = self.value_as_uint_64_value() {
                    ds.field("value", &x)
                } else {
                    ds.field(
                        "value",
            ...
            HttpParameterValue::Float32Value => {
                if let Some(x) = self.value_as_float_32_value() {
                    ds.field("value", &x)
                } else {
                    ds.field(
                        "value",
